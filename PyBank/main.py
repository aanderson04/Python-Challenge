...
with open (output_path, 'w') as txtfile:
    ...
    txtfile.write('------------------------------')
    txtfile.write('Total Months: {len(total_months)}')
    txtfile.write('Total: ${sum(total_revenue)}')
    txtfile.write('Average Change: ${sum(average_change)/ len(average_change)}')
    txtfile.write('Greatest Increase in Profits: {total_months[month_max_profit]} (${(max_profit)})')
    txtfile.write('Greatest Decrease in Profits: {total_months[month_min_profit]} (${(min_profit)})')